...
namespace UwCore.Behaviors
{
    ...
    public class PasswordBoxEnterTriggerBehavior : Behavior<PasswordBox>
    {
        public static readonly DependencyProperty ActionsProperty = DependencyProperty.Register(
            "Actions",
            typeof(ActionCollection),
            typeof(PasswordBoxEnterTriggerBehavior),
        ...
        public static readonly DependencyProperty OnKeyDownProperty = DependencyProperty.Register(
            ...
            typeof(bool),
            typeof(PasswordBoxEnterTriggerBehavior),
            new PropertyMetadata(default(bool), (s, e) => ((PasswordBoxEnterTriggerBehavior)s).OnOnKeyDownChanged((bool)e.OldValue, (bool)e.NewValue)));
